        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>عرض</strong> الوظيفة</h2>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                               placeholder="العنوان" value="{{ $job->title }}" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="employer" class="form-control"
                                               placeholder="صاحب العمل" value="{{ $job->employer->username }}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category" class="form-control"
                                               placeholder="المجال" value="{{ $job->category->name }}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="region" class="form-control"
                                               placeholder="المحافظة" value="{{ $job->region->name }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix" style="margin-bottom: 15px">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <small style="margin-right: 15px"><b>نوع الوظيفة</b></small>
                                        <input type="text" name="jobType" class="form-control"
                                               placeholder="نوع الوظيفة" value="{{ $job->jobTypeText }}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <small style="margin-right: 15px"><b>الفئة المستهدفة</b></small>
                                        <input type="text" name="jobType" class="form-control"
                                               placeholder="الفئة المستهدفة" value="{{ $job->forText }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <small style="margin-right: 15px"><b>نوع الراتب</b></small>
                                        <input type="text" name="salaryType" class="form-control"
                                               placeholder="نوع الراتب" value="{{ $job->salaryTypeText }}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <small style="margin-right: 15px"><b>الراتب</b></small>
                                        <input type="number" name="salary_amount" class="form-control"
                                               step="0.01" min="0.01"
                                               placeholder="الراتب" value="{{ $job->salary_amount }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="requirement" rows="7" class="form-control no-resize requirement"
                                                  ...
                                                  disabled>{{ $job->requirement }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input type="date" name="last_date" class="form-control"
                                               placeholder="آخر موعد للتقديم" value="{{ $job->last_date }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
