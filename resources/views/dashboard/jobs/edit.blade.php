        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>تعديل</strong> الوظيفة</h2>
                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="title" class="form-control"
                                                   placeholder="العنوان" value="{{ $job->title }}">
                                            @error('title')
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control z-index show-tick nominate_beneficiary"
                                            ...
                                            @foreach($employers as $employer)
                                                <option {{ $job->employer_id === $employer->id ? 'selected' : '' }} value="{{ $employer->id }}">
                                                    {{ $employer->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control z-index show-tick nominate_beneficiary"
                                            ...
                                            @foreach($regions as $region)
                                                <option {{ $job->region_id === $region->id ? 'selected' : '' }} value="{{ $region->id }}">
                                                    {{ $region->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row clearfix" style="margin-bottom: 15px">
                                    <div class="col-sm-4">
                                        <select class="form-control z-index show-tick nominate_beneficiary"
                                            ...
                                            <option value="1" {{ $job->jobType == 1 ? 'selected' : '' }}>دوام كامل</option>
                                            <option value="2" {{ $job->jobType == 2 ? 'selected' : '' }}>دوام جزئي</option>
                                            <option value="3" {{ $job->jobType == 3 ? 'selected' : '' }}>عن بعد</option>
                                        </select>
                                        @error('jobType')
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control z-index show-tick nominate_beneficiary"
                                            ...
                                            <option value="1" {{ $job->for == 1 ? 'selected' : '' }}>أشخاص</option>
                                            <option value="2" {{ $job->for == 2 ? 'selected' : '' }}>فرق</option>
                                        </select>
                                        @error('for')
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                        <select class="form-control z-index show-tick nominate_beneficiary"
                                            ...
                                            <option value="1" {{ $job->salary_type == 1 ? 'selected' : '' }}>ثابت</option>
                                            <option value="2" {{ $job->salary_type == 2 ? 'selected' : '' }}>بالساعة</option>
                                        </select>
                                        @error('salary_type')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <input type="number" name="salary_amount" class="form-control"
                                                   step="0.01" min="0.01"
                                                   placeholder="الراتب" value="{{ $job->salary_amount }}">
                                            @error('salary_amount')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="description" rows="7" class="form-control no-resize"
                                                      placeholder="الوصف الوظيفي...">{{ $job->description }}</textarea>
                                            @error('description')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="requirement" rows="7" class="form-control no-resize"
                                                      placeholder="المتطلبات...">{{ $job->requirement }}</textarea>
                                            @error('requirement')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <input type="date" name="last_date" class="form-control"
                                                   placeholder="آخر موعد للتقديم" value="{{ $job->last_date }}">
                                            @error('last_date')
