                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><i class="zmdi zmdi-home"></i>لوحة
                                التحكم</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/trainingApplications') }}">المتقدمين
                                للتدريبات</a></li>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card patients-list">
                        <div class="header">
                            <h2><strong>المتقدمين للتدريبات </strong><span>({{$applications->total()}})</span></h2>
                        </div>
                        @include('layouts.dashboard._message')
                        <div class="body">
                            <div class="col-12" style="padding-right: 0px">
                                <form action="{{ route('dashboard.trainingApplications.index') }}" method="GET">
                                    <div class="row clearfix">
                                    ...
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        @forelse($applications as $application)
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank"
                                                       href="{{ route('dashboard.trainings.show', $application->applicationable->id) }}">{{ $application->applicationable->title }}</a>
                                                </td>
                                                <td>
                                                    <a target="_blank"
                                                ...
                                                <td>
                                                    @if(auth()->guard('admin')->user()->hasPermission('delete_applications'))
                                                        <form action="{{ route('dashboard.trainingApplications.destroy', $application) }}"
