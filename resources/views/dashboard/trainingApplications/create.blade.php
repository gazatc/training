                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{ url('dashboard') }}"><i class="zmdi zmdi-home"></i>
                                لوحة التحكم</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/trainingApplications') }}">المتقدمين للتدريبات</a></li>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>التقديم</strong> لتدريب</h2>
                        </div>

                        <div class="body">
                            <form action="{{route('dashboard.trainingApplications.store')}}" method="POST"
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        @error('training')
                                            <span style="color: red; margin-right: 10px">{{ $errors->first('training') }}</span>
                                        @enderror
                                    </div>
