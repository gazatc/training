                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><i class="zmdi zmdi-home"></i>لوحة
                                التحكم</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/jobInquires') }}">استفسارات الوظائف</a>
                        </li>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card patients-list">
                        <div class="header">
                            <h2><strong>استفسارات الوظائف </strong><span>({{$inquires->total()}})</span></h2>
                        </div>
                        @include('layouts.dashboard._message')
                        <div class="body">
                            <div class="col-12" style="padding-right: 0px">
                                <form action="{{ route('dashboard.jobInquires.index') }}" method="GET">
                                    <div class="row clearfix">
                                    ...
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        @forelse($inquires as $inquire)
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank"
                                                       href="{{ route('dashboard.jobs.show', $inquire->inquirable->id) }}">{{ $inquire->inquirable->title }}</a>
                                                </td>
                                                <td>
                                                    <a target="_blank"
                                                ...
                                                <td>
                                                    @if(auth()->guard('admin')->user()->hasPermission('delete_inquires'))
                                                        <form action="{{ route('dashboard.jobInquires.destroy', $inquire) }}"
