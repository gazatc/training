                    ...
                    <div class="bg-white rounded-lg border border-gray-300 shadow-lg">
                        ...
                        <div class="px-2 py-4">
                            <div>
                                ...
                                <div class="flex justify-center mt-2 font-semibold text-sm">مجال الشركة</div>
                            </div>
                            ...
                            <div class="py-2 px-6 mb-2">
                                ...
                                <div class="grid lg:grid-cols-3 grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <span class="text-sm">مجال الشركة</span>
                                    </div>
                                    <div>
                                        <span class="text-base font-semibold">النوع : </span>
                                        <span class="text-sm">مؤسسة أهلية محلية</span>
                                    </div>
                                    <div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <span class="text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium, laborum.</span>
                                    </div>
                                    <div>
