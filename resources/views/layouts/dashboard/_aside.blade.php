                ...
                <ul class="list">
                    ...
                    @if(auth()->guard('admin')->user()->hasPermission('read_admins'))
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li><a href="{{route('dashboard.admins.index')}}">كل المشرفين</a></li>
                                @if(auth()->guard('admin')->user()->hasPermission('create_admins'))
                                    <li><a href="{{route('dashboard.admins.create')}}">إضافة مشرف</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    ...
                    {{--@if(auth()->guard('admin')->user()->hasPermission('read_clients'))--}}
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li><a href="{{route('dashboard.roles.index')}}">كل الصلاحيات</a></li>
{{--                                @if(auth()->guard('admin')->user()->hasPermission('create_clients'))--}}
                                    <li><a href="{{route('dashboard.roles.create')}}">إصافة صلاحية</a></li>
                                {{--@endif--}}
                            </ul>
                        </li>
                    {{--@endif--}}
