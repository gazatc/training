                                ...
                                <div class="px-2 py-4">
                                    <div class="space-y-2">
                                        ...
                                        <div class="text-base mt-1">
                                            <a href="{{route('employer.show',$employer)}}" class="flex justify-center font-semibold">
                                        ...
                                        <div class="flex text-sm text-center justify-center items-center">
                                            ...
                                            <span class="mr-1">{{$employer->information->category->name}}</span>
                                        </div>
                                        <div class="flex text-sm items-center justify-center">
                                            ...
                                            <span class="mr-1">{{$employer->information->region->name}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
