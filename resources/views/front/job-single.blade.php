                            ...
                            <div>
                                ...
                                @if(auth()->guard('jobSeeker')->check())
                                    ...
                                    @else
                                        @if($job->last_date >= today()->toDateString())
                                            ...
                                            @if($job->getForTextAttribute() == "فرق")
                                                @if(@auth()->guard('jobSeeker')->user()->verified()->has('team')->orHas('teamLeader')->first() != NULL)
                                             ...
                                             rounded py-2 px-4 focus:outline-none focus:ring-2 ">يرجى الانضمام لفرقة للتقديم</span>
                                                @endif
                                            @elseif($job->getForTextAttribute() == "أشخاص")
                                                <form action="{{route('job.apply',$job)}}" method="post">
                                                    @csrf
                                ...
                                @else
                                    <a href="{{route('jobSeeker.login_form')}}"
                                       class="block text-red-600 pt-3 hover:underline">يرجى تسجيل الدخول للتقديم</a>
                                @endif
                            </div>
                        </div>
                    </div>
