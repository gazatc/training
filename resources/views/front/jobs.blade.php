                        ...
                        <form action="" class="px-2 py-2">
                            ...
                            <div class="flex flex-col">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" class="form-checkbox h-3.5 w-3.5"><span class="mr-2 text-sm text-gray-700">اشخاص</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input type="checkbox" class="form-checkbox h-3.5 w-3.5"><span class="mr-2 text-sm text-gray-700">فرق</span>
                                </label>
                            </div><hr class="my-2">
                        ...
                        <div class="lg:flex items-center justify-between border-b py-4 px-6 hover:bg-gray-100 rounded-t-lg">
                            <div class="flex">
                                ...
                                <div class="mr-4">
                                    ...
                                    <span class="text-xs mr-1">{{ date('Y/m/d', strtotime($job->created_at))}}</span>
                                    <div class="text-xs mt-1">
                                        <div class="flex">
                                            ...
                                            <a href="{{route('employer.show',$job->employer)}}" class="mr-1 text-blue-500">{{$job->employer->name}}</a>
                                        </div>
                                    </div>
                                    <div class="flex text-xs mt-2">
                                        <div class="flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 64 64">
                                                <path fill="#222" d="M49.24,24.26V39.74a9.51,9.51,0,0,1-9.5,9.5H24.26a9.51,9.51,0,0,1-9.5-9.5V24.26a9.51,9.51,0,0,1,9.5-9.5H39.74A9.51,9.51,0,0,1,49.24,24.26Z"></path></svg>
