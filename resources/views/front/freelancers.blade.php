                        ...
                        <div class="px-2 py-4">
                            ...
                            <div class="space-y-2">
                                <img class="m-auto rounded w-36 h-36"
                                     @if(!empty($freelancer->information->avatar))
                                     src="{{$freelancer->information->avatar}}"
                                     @else
                                ...
                                <div class="text-base text-center mt-1">
                                    <a href="{{route('jobseeker.show',$freelancer)}}" class="flex items-center justify-center font-semibold">
                                        ...
                                        <span class="text-blue-500 mr-1">{{$freelancer->name}}</span>
                                ...
                                <div class="flex text-sm text-center justify-center items-center">
                                    ...
                                    <span class="mr-1">{{$freelancer->information->category->name}}</span>
                                </div>
                                <div class="flex text-center text-sm items-center justify-center">
                                    ...
                                    <span class="">{{$freelancer->information->region->name}}</span>
                                </div>
                            </div>
