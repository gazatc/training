                ...
                <div class="w-full lg:w-3/4">
                    ...
                    <div class="shadow-lg bg-white rounded-lg border border-gray-300 mt-6 lg:mt-0 lg:mr-8">
                        ...
                        text-lg font-semibold mb-2 py-2 px-6 bg-gray-100 flex justify-between items-center">
                            ...
                            <form action="{{route('jobSeeker.profile.experience.update',$jobSeekerExperience->id)}}" method="post">
                                @csrf
                                ...
                                <div class="grid md:grid-cols-2 gap-5 ">
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="name"
                                                   ...
                                                   placeholder="عنوان" value="{{$jobSeekerExperience->name}}"
                                                   type="text">
                                            @error('name')
                                            <span
                                    ...
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="company"
                                                   class="border border-gray-300 w-full  text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="اسم الشركة/المؤسسة" value="{{$jobSeekerExperience->company}}"
                                                   type="text">
                                            @error('company')
                                            <span
                                    ...
                                    <div class="py-2 px-6">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="from"
                                                   class="border border-gray-300 w-full  text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="من" value="{{$jobSeekerExperience->from}}"
                                                   type="date">
                                            @error('from')
                                            <span
                                    ...
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="to"
                                                   class="border border-gray-300 w-full   text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="الى" value="{{$jobSeekerExperience->to}}"
                                                   type="date">
                                            @error('to')
                                            <span
