                ...
                <div class="w-full lg:w-3/4">
                    ...
                    <div class="shadow-lg bg-white rounded-lg border border-gray-300 mt-6 lg:mt-0 lg:mr-8">
                        ...
                        text-lg font-semibold mb-2 py-2 px-6 bg-gray-100 flex justify-between items-center">
                            ...
                            <form action="{{route('jobSeeker.profile.training.update',$jobSeekerTraining->id)}}" method="post">
                                @csrf
                                ...
                                <div class="grid md:grid-cols-2 gap-5 ">
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="name"
                                                   ...
                                                   placeholder="عنوان" value="{{$jobSeekerTraining->name}}"
                                                   type="text">
                                            @error('name')
                                            <span
                                    ...
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            <div class="block my-2">
                                                <label for="">الجامعة/المعهد/المؤسسة الى اخ...</label>
                                            </div>
                                            <input name="institution"
                                                   class="border border-gray-300 w-full  text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="اسم الشركة/المؤسسة" value="{{$jobSeekerTraining->institution}}"
                                                   type="text">
                                            @error('institution')
                                            <span
                                    ...
                                    <div class="py-2 px-6">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="from"
                                                   class="border border-gray-300 w-full  text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="من" value="{{$jobSeekerTraining->from}}"
                                                   type="date">
                                            @error('from')
                                            <span
                                    ...
                                    <div class="py-2 px-6 ">
                                        <div class="mt-2 text-justify">
                                            ...
                                            <input name="to"
                                                   class="border border-gray-300 w-full   text-sm rounded-sm px-3 py-2 focus:outline-none focus:border-blue-900"
                                                   placeholder="الى" value="{{$jobSeekerTraining->to}}"
                                                   type="date">
                                            @error('to')
                                            <span
