                ...
                <div class="py-2">
                    ...
                    <div class="pt-3">
                        <input type="password" required name="password"
                               class="border border-gray-300 @error('password') border-red-500 @enderror w-full text-sm rounded-sm bg-gray-100 px-3 py-1.5 focus:outline-none focus:border-blue-900">
                    </div>
                </div>
                <div class="py-2">
                    <div>
